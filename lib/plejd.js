...
class PlejdCommands {
  ...
  notificationParse(data) {
    ...
    // null = deze melding bevat geen dimwaarde. Niet 255: een kale aan/uit-
    // melding heeft geen dim-payload, en 255 wegschrijven zet de helderheid
    // stilletjes op 100% en laat dim_changed-flows afgaan.
    let dim = null;
    let state = null;
    let cmd = 'unknown';
    let color = null;
